...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/compare.vue?vue&type=template&id=200dacef&
var render=function render(){var _vm=this,_c=_vm._self._c;return _c('div',{staticClass:"compare-page-wrapper"},[_c('HeaderWithTopbar',{attrs:{"containerClass":"container"}}),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"pageTitle":"compare"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"compare-page-wrapper pt-100 pb-100\">","</div>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-12\">","</div>",[_vm.products.length>0?_vm._ssrNode("<div class=\"compare-page-content-wrap\">","</div>",[_vm._ssrNode("<div class=\"compare-table table-responsive\">","</div>",[_vm._ssrNode("<table class=\"table table-bordered mb-0\">","</table>",[_vm._ssrNode("<tbody>","</tbody>",[_vm._ssrNode("<tr>","</tr>",[_vm._ssrNode("<td class=\"first-column\">Product</td> "),_vm._l(_vm.products,function(product,index){return _vm._ssrNode("<td class=\"product-image-title\">","</td>",[_c('n-link',{staticClass:"image",attrs:{"to":`/product/${_vm.slugify(product.title)}`}},[_c('img',{staticClass:"img-fluid",attrs:{"src":product.images[0],"alt":product.title}})]),_vm._ssrNode(" "),_vm._ssrNode("<h4 class=\"title\">","</h4>",[_c('n-link',{attrs:{"to":`/product/${_vm.slugify(product.title)}`}},[_vm._v(_vm._s(product.title))])],1)],2);})],2),_vm._ssrNode(" <tr><td class=\"first-column\">Description</td> "+_vm._ssrList(_vm.products,function(product,index){return"<td class=\"pro-desc\"><p>"+_vm._ssrEscape(_vm._s(product.description))+"</p></td>";})+"</tr> <tr><td class=\"first-column\">Price</td> "+_vm._ssrList(_vm.products,function(product,index){return"<td class=\"pro-price\"><span>"+_vm._ssrEscape("$"+_vm._s(_vm.discountedPrice(product).toFixed(2)))+"</span> "+(product.discount>0?"<del class=\"old\">"+_vm._ssrEscape("$"+_vm._s(product.price.toFixed(2)))+"</del>":"<!---->")+"</td>";})+"</tr> <tr><td class=\"first-column\">Add to cart</td> "+_vm._ssrList(_vm.products,function(product,index){return"<td><button class=\"btn\">Add to Cart</button></td>";})+"</tr> <tr><td class=\"first-column\">Rating</td> "+_vm._ssrList(_vm.products,function(product,index){return"<td class=\"pro-ratting\"><i class=\"fa fa-star\"></i> <i class=\"fa fa-star\"></i> <i class=\"fa fa-star\"></i> <i class=\"fa fa-star\"></i> <i class=\"fa fa-star-o\"></i></td>";})+"</tr> <tr><td class=\"first-column\">Remove</td> "+_vm._ssrList(_vm.products,function(product,index){return"<td class=\"pro-remove\"><button><i class=\"fa fa-trash-o\"></i></button></td>";})+"</tr>")],2)])])]):_vm._ssrNode("<div class=\"empty-cart text-center\">","</div>",[_vm._ssrNode("<div class=\"icon\"><i class=\"pe-7s-shuffle\"></i></div> <h4>No items found in compare</h4> "),_c('n-link',{staticClass:"empty-cart__button",attrs:{"to":"/shop"}},[_vm._v("Add Item")])],2)])])])]),_vm._ssrNode(" "),_c('TheFooter')],2);};var staticRenderFns=[];
// CONCATENATED MODULE: ./pages/compare.vue?vue&type=template&id=200dacef&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/compare.vue?vue&type=script&lang=js&
/* harmony default export */ var comparevue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53)),Breadcrumb:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 54)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 52))},computed:{products(){return this.$store.getters.getCompare;}},methods:{addToCart(product){const prod={...product,cartQuantity:1};// for notification
...
this.$notify({title:'Item remove from compare!'});this.$store.dispatch('removeFromCompare',product);},discountedPrice(product){return product.price-product.price*product.discount/100;},slugify(text){return text.toString().toLowerCase().replace(/\s+/g,"-")// Replace spaces with -
.replace(/[^\w-]+/g,"")// Remove all non-word chars
.replace(/--+/g,"-")// Replace multiple - with single -
.replace(/^-+/,"")// Trim - from start of text
.replace(/-+$/,"");// Trim - from end of text
}},head(){return{title:"Compare"};}});
