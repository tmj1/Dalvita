...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/wishlist.vue?vue&type=template&id=013e2971&
var render=function render(){var _vm=this,_c=_vm._self._c;return _c('div',{staticClass:"cart-page-wrapper"},[_c('HeaderWithTopbar',{attrs:{"containerClass":"container"}}),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"pageTitle":"wishlist"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"cart-main-area pt-90 pb-100\">","</div>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm.products.length>0?_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-12\">","</div>",[_vm._ssrNode("<h3 class=\"cart-page-title\">Your wishlist items</h3> "),_vm._ssrNode("<div class=\"table-content table-responsive cart-table-content\">","</div>",[_vm._ssrNode("<table>","</table>",[_vm._ssrNode("<thead><tr><th>Image</th> <th>Product Name</th> <th>Until Price</th> <th>Add To Cart</th> <th>Action</th></tr></thead> "),_vm._ssrNode("<tbody>","</tbody>",_vm._l(_vm.products,function(product,index){return _vm._ssrNode("<tr>","</tr>",[_vm._ssrNode("<td class=\"product-thumbnail\">","</td>",[_c('n-link',{attrs:{"to":`/product/${_vm.slugify(product.title)}`}},[_c('img',{attrs:{"src":product.images[0],"alt":product.title}})])],1),_vm._ssrNode(" "),_vm._ssrNode("<td class=\"product-name\">","</td>",[_c('n-link',{attrs:{"to":`/product/${_vm.slugify(product.title)}`}},[_vm._v(_vm._s(product.title))])],1),_vm._ssrNode(" <td class=\"product-price-cart\"><span class=\"amount\">"+_vm._ssrEscape("$"+_vm._s(_vm.discountedPrice(product).toFixed(2)))+"</span> "+(product.discount>0?"<del class=\"old\">"+_vm._ssrEscape("$"+_vm._s(product.price.toFixed(2)))+"</del>":"<!---->")+"</td> <td class=\"product-wishlist-cart\"><button>add to cart</button></td> <td class=\"product-remove\"><button><i class=\"fa fa-times\"></i></button></td>")],2);}),0)],2)])],2)]):_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-12\">","</div>",[_vm._ssrNode("<div class=\"empty-cart text-center\">","</div>",[_vm._ssrNode("<div class=\"icon\"><i class=\"pe-7s-like\"></i></div> <h4>No items found in wishlist</h4> "),_c('n-link',{staticClass:"empty-cart__button",attrs:{"to":"/shop"}},[_vm._v("Add Item")])],2)])])])]),_vm._ssrNode(" "),_c('TheFooter')],2);};var staticRenderFns=[];
// CONCATENATED MODULE: ./pages/wishlist.vue?vue&type=template&id=013e2971&
...
/* harmony default export */ var wishlistvue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53)),Breadcrumb:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 54)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 52))},computed:{products(){return this.$store.getters.getWishlist;}},methods:{addToCart(product){const prod={...product,cartQuantity:1};// for notification
if(this.$store.state.cart.find(el=>product.id===el.id)){this.$notify({title:'Already added to cart update with one'});}else{this.$notify({title:'Add to cart successfully!'});}this.$store.dispatch('addToCartItem',prod);},removeProductFromWishlist(product){// for notification
this.$notify({title:'Remove item from wishlist!'});this.$store.dispatch('removeProductFromWishlist',product);},discountedPrice(product){return product.price-product.price*product.discount/100;},slugify(text){return text.toString().toLowerCase().replace(/\s+/g,"-")// Replace spaces with -
.replace(/[^\w-]+/g,"")// Remove all non-word chars
.replace(/--+/g,"-")// Replace multiple - with single -
.replace(/^-+/,"")// Trim - from start of text
.replace(/-+$/,"");// Trim - from end of text
}},head(){return{title:"Wishlist"};}});
