...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/blog-without-sidebar.vue?vue&type=template&id=b2727a0e&
var render=function render(){var _vm=this,_c=_vm._self._c;return _c('div',{staticClass:"blog-without-sidebar"},[_c('HeaderWithTopbar',{attrs:{"containerClass":"container"}}),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"pageTitle":"blog without sidebar"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"blog-area pt-100 pb-100\">","</div>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-12\">","</div>",[_vm._ssrNode("<div class=\"ml-20\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",_vm._l(_vm.getItems,function(blog,index){return _vm._ssrNode("<div class=\"col-lg-4 col-md-6 col-12\">","</div>",[_c('BlogItemStyleTwo',{attrs:{"blog":blog}})],1);}),0)]),_vm._ssrNode(" "),_vm.getPaginateCount>1?_vm._ssrNode("<div>","</div>",[_c('pagination',{staticClass:"pro-pagination-style shop-pagination mt-30",attrs:{"per-page":_vm.perPage,"records":_vm.blogData.length,"page-count":_vm.getPaginateCount},on:{"paginate":_vm.paginateClickCallback},model:{value:_vm.currentPage,callback:function($$v){_vm.currentPage=$$v;},expression:"currentPage"}})],1):_vm._e()],2)])])]),_vm._ssrNode(" "),_c('TheFooter')],2);};var staticRenderFns=[];
// CONCATENATED MODULE: ./pages/blog/blog-without-sidebar.vue?vue&type=template&id=b2727a0e&

// EXTERNAL MODULE: ./data/blog.json
var blog = __webpack_require__(60);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/blog-without-sidebar.vue?vue&type=script&lang=js&
/* harmony default export */ var blog_without_sidebarvue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53)),BlogItemStyleTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 64)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 52))},data(){return{blogData: blog,currentPage:1,perPage:6};},computed:{getItems(){let start=(this.currentPage-1)*this.perPage;let end=this.currentPage*this.perPage;return this.blogData.slice(start,end);},getPaginateCount(){return Math.ceil(this.blogData.length/this.perPage);}},methods:{paginateClickCallback(pageNum){this.currentPage=Number(pageNum);}},head(){return{title:"Blog Without Sidebar"};}});
// CONCATENATED MODULE: ./pages/blog/blog-without-sidebar.vue?vue&type=script&lang=js&
 /* harmony default export */ var blog_blog_without_sidebarvue_type_script_lang_js_ = (blog_without_sidebarvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/blog/blog-without-sidebar.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  blog_blog_without_sidebarvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var blog_without_sidebar = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {HeaderWithTopbar: __webpack_require__(53).default,Breadcrumb: __webpack_require__(54).default,BlogItemStyleTwo: __webpack_require__(64).default,TheFooter: __webpack_require__(52).default})
...
//# sourceMappingURL=blog-without-sidebar.js.map